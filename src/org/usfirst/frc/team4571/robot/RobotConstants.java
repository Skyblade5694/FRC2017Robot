...
public class RobotConstants {
	...
	// Drive subsystem
	public static final int DRIVE_FRONT_LEFT_MOTOR_CHANNEL = 5;
	public static final int DRIVE_FRONT_RIGHT_MOTOR_CHANNEL = 2;
	public static final int DRIVE_REAR_LEFT_MOTOR_CHANNEL = 4;
	public static final int DRIVE_REAR_RIGHT_MOTOR_CHANNEL = 1;
...
//	
	...
	//public static final int INTAKE_SHIFTER_FORWARD_SOLENOID_CHANNEL = 3;
	//public static final int INTAKE_SHIFTER_REVERSE_SOLENOID_CHANNEL = 2;
	//public static final int INTAKE_HALF_SOLENOID_CHANNEL = 3;
	//public static final int INTAKE_MOTOR_CHANNEL = 5;
//
	// Shifter subsystem
	public static final int SHIFTER_FORWARD_SOLENOID_CHANNEL = 3;
	public static final int SHIFTER_REVERSE_SOLENOID_CHANNEL = 2;
//
//	// Mill subsystem
